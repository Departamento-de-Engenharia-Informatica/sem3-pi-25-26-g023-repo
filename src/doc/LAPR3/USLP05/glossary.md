...
This document provides an alphabetical list of the key business terms and concepts for the "Logistics On Rails" project, covering Sprints 1 and 2.
...
| **Endpoint (Stop)** | A station in a planned route. The BDDAD (Sprint 2) data must record whether the train stops at that endpoint or just passes through. |
...
| **Planned Train Route** | A new concept in Sprint 2 (BDDAD). The defined sequence of line segments and endpoints (stations) for a specific train. |
