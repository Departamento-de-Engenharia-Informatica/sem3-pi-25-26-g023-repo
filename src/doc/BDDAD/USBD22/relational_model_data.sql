...
-- Código Corrigido com sintaxe Oracle (INSERT ALL)
-- =============================================
...
INSERT ALL
  INTO WAGON_MODEL (model_id, model_name, maker, wagon_type, gauge_mm) VALUES (1245, 'Tadgs 32 94 082 3', 'Metalsines', 'Cereal wagon', 1668)
  INTO WAGON_MODEL (model_id, model_name, maker, wagon_type, gauge_mm) VALUES (1278, 'Tdgs 41 94 074 1', 'Equimetal', 'Cereal wagon', 1668)
  INTO WAGON_MODEL (model_id, model_name, maker, wagon_type, gauge_mm) VALUES (1325, 'Gabs 81 94 181 1', 'Sepsa Cometna', 'Covered wagon with sliding door', 1668)
  INTO WAGON_MODEL (model_id, model_name, maker, wagon_type, gauge_mm) VALUES (1104, 'Regmms 32 94 356 3', 'Metalsines', 'Container wagon (max 40'' HC)', 1668)
  INTO WAGON_MODEL (model_id, model_name, maker, wagon_type, gauge_mm) VALUES (1212, 'Kbs 41 94 333', 'Simmering', 'Wood wagon', 1668)
SELECT * FROM DUAL;
...
INSERT ALL
  INTO TRAIN (train_id, operator_id, train_date, train_time, start_facility_id, end_facility_id, locomotive_id, route_id) VALUES ('5421', 'MEDWAY', DATE '2025-10-03', '09:45:00', 50, 11, '5621', 'R001')
  INTO TRAIN (train_id, operator_id, train_date, train_time, start_facility_id, end_facility_id, locomotive_id, route_id) VALUES ('5435', 'MEDWAY', DATE '2025-10-03', '18:00:00', 11, 50, '5623', 'R002')
  INTO TRAIN (train_id, operator_id, train_date, train_time, start_facility_id, end_facility_id, locomotive_id, route_id) VALUES ('5437', 'MEDWAY', DATE '2025-10-06', '10:00:00', 11, 50, '5621', 'R002')
SELECT * FROM DUAL;
